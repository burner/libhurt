...
module hurt.net.localserver;

private import  core.exception,
				core.sys.posix.unistd,
				core.sys.posix.sys.socket;
	   
private import  hurt.net.server,
				hurt.net.socket,
				hurt.net.localsocket,
				hurt.net.localaddress;
...
class LocalServer : Server
{
	 ...
	 * 
	 * params:
	 *  address = the address structure usually created by hurt.net.localaddress or null if it should not listen
	 *  backlog = number of maximal concurrant waiting connection
	 */
	 ...
	 * 
	 * Params:
	 *  address = an address structure usually created from hurt.net.localaddress
	 * 
	 * ---
	 * private import hurt.net.localaddress;
	 * 
