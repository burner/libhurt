...
*******************************************************************************/
module hurt.util.random.normalsource;
...
class NormalSource(RandG,T) 
    ...
    static real cumProbDensityFCompl(real x){ 
		return sqrt(0.5L*PI)*std.mathspecial.erfc(x/sqrt(2.0L));/*normalDistributionCompl(x);*/ }
